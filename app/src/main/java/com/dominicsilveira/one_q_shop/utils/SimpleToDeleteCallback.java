...
abstract public class SimpleToDeleteCallback extends ItemTouchHelper.Callback {
    static String TAG = SimpleToDeleteCallback.class.getSimpleName();
    Context mContext;
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        Log.e(TAG,"Swipe delete icon: "+String.valueOf(deleteIconLeft)+" "+String.valueOf(deleteIconRight)+" "+String.valueOf(intrinsicWidth)+" "+String.valueOf(deleteIconMargin));
